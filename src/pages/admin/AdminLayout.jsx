...
export default function AdminLayout() {
  ...
  return (
    <div className="h-screen overflow-hidden bg-slate-100/80 text-slate-900 flex flex-col font-['Plus_Jakarta_Sans',sans-serif]">
      ...
      <Outlet />
      <ConfirmationModal isOpen={signOutConfirmOpen} onClose={() => setSignOutConfirmOpen(false)} title="Sign out of the admin portal?" message="You will need to sign in again to manage Senga Systems content and settings." confirmLabel="Sign out" onConfirm={handleSignOut} successMessage="Signing out…" />
            </div>
          </div>
        </main>
