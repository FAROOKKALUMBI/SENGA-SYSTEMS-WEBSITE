...
export default function HomePage() {
  ...
  return (
    <div className="space-y-0 font-['Plus_Jakarta_Sans',sans-serif]">
      ...
      <section className="relative min-h-[520px] lg:min-h-[580px] pt-14 pb-20 md:pt-20 md:pb-28 bg-gradient-to-r from-[#17386d] via-[#122e5a] to-[#0c1f3f] text-white overflow-hidden flex items-center max-md:flex-col max-md:items-stretch">
        
        {/* Right Monitor Code Blur Overlay */}
        <div 
          className="hero-visual order-2 md:order-none absolute inset-y-0 right-0 w-full lg:w-3/5 bg-cover bg-right bg-no-repeat opacity-40 mix-blend-luminosity pointer-events-none"
        ...
        <div className="order-1 md:order-none max-w-7xl mx-auto px-4 md:px-12 relative z-10 w-full text-left">
